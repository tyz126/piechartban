...
public record HandshakeS2CPayload(boolean idk) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, HandshakeS2CPayload> CODEC = PacketCodec.tuple(PacketCodecs.BOOL, HandshakeS2CPayload::idk, HandshakeS2CPayload::new);
